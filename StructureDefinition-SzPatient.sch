...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://172.209.216.154:3447/fhir/StructureDefinition/SzRegistrationDate']) &gt;= 1">extension with URL = 'http://172.209.216.154:3447/fhir/StructureDefinition/SzRegistrationDate': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://172.209.216.154:3447/fhir/StructureDefinition/SzRegistrationDate']) &lt;= 1">extension with URL = 'http://172.209.216.154:3447/fhir/StructureDefinition/SzRegistrationDate': maximum cardinality of 'extension' is 1</sch:assert>
